...
/**
 * 标准与政策-泰山茶标准
 * @TableName app_db_policy_tea_standard
 */
@TableName(value ="app_db_policy_tea_standard")
@Data
public class AppDbPolicyTeaStandard implements Serializable {
    /**
     * id
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        AppDbPolicyTeaStandard other = (AppDbPolicyTeaStandard) that;
