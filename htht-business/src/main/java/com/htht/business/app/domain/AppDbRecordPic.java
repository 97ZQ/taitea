...
/**
 * 农事记录图片
 * @TableName app_db_record_pic
 */
@TableName(value ="app_db_record_pic")
@Data
public class AppDbRecordPic implements Serializable {
    /**
     * id
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        AppDbRecordPic other = (AppDbRecordPic) that;
