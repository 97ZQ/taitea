...
public class OkHttpUtils {
     ...
     * @return
     */
    public OkHttpUtils addParam(boolean condition, String key, Object value) {
        if (paramMap == null) {
    ...
    public OkHttpUtils get() {
        ...
        log.info("GET请求参数：" + urlBuilder.toString());
        return this;
    }

    public OkHttpUtils post(boolean isJsonPost) {
        return post(isJsonPost, "");
    }
     ...
     * @return
     */
    public OkHttpUtils post(boolean isJsonPost, String end) {
        RequestBody requestBody;
        if (isJsonPost) {
            String json = "";
            if (paramMap != null) {
                json = JsonUtils.toJsonString(paramMap) + end;
            }
